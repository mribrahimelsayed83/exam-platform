      ...
      <section style={{background:`linear-gradient(135deg, ${bg} 0%, ${bg}dd 60%, ${bg}99 100%)`}}
        ...
        <div className="max-w-6xl mx-auto px-4 py-20 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-shrink-0 relative w-56 h-56 lg:w-72 lg:h-72">
              <div className="lp-blob absolute inset-0"
                style={{background:'linear-gradient(135deg, rgba(255,255,255,0.35), rgba(255,255,255,0.05))'}}/>
              <div className="absolute inset-3 rounded-[2.5rem] overflow-hidden bg-white/20 border-4 border-white/30 shadow-2xl">
                {data.hero_image ? (
              ...
              <span className="lp-float absolute -top-3 -left-3 w-11 h-11 bg-white rounded-2xl shadow-lg flex items-center justify-center border border-white/50" style={{color:bg}}><FaGraduationCap size={20}/></span>
              <span className="lp-float-delay absolute top-1/3 -right-5 w-10 h-10 bg-white rounded-2xl shadow-lg flex items-center justify-center border border-white/50" style={{color:bg}}><FaPencilAlt size={16}/></span>
              <span className="lp-float-delay2 absolute -bottom-4 left-6 w-11 h-11 bg-white rounded-2xl shadow-lg flex items-center justify-center border border-white/50" style={{color:bg}}><FaBookOpen size={19}/></span>
              <span className="lp-float absolute bottom-8 -right-6 w-9 h-9 bg-white rounded-2xl shadow-lg flex items-center justify-center border border-white/50" style={{color:bg}}><FaFlask size={15}/></span>
            </div>
          </div>
        </div>
